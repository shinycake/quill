    ...
    while let Some(arg) = iter.next() {
        if arg == "--screenshot-demo" {
            ...
            let demo = match kind {
                ...
                "ready-audio-send" => ScreenshotDemo::ReadyAudioSend,
...
fn run_screenshot_demo(demo: (ui::ScreenshotDemo, std::path::PathBuf)) {
    ...
    let marker = out_dir.join(match kind {
        ...
        ScreenshotDemo::ReadyAudioSend => ".quill-ready-ready-audio-send",
