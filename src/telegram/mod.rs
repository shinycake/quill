...
pub use envelope::{
    ...
    PhotoSizeView, Poll, PollContent, PollOption, PollType, ReactionType, StickerContent,
...
pub use requests::{
    PollSend, SetTdlibParameters, VideoNoteSend, VideoNoteThumbnailSend, VideoSend,
    ...
    send_document, send_photo, send_poll, send_sticker, send_text, send_video, send_video_note,
    send_voice_note, set_authentication_phone_number, set_chat_draft_message, set_poll_answer,
    view_messages,
};
