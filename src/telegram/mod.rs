...
pub use envelope::{
    ...
    ParsedFile, ParsedMessage, PhotoContent, PhotoSizeView, ReactionType, StickerContent,
    StickerFormat, StickerItem, StickerSetInfo, TdError, UnknownKind, VoiceNoteContent,
...
pub use requests::{
    ...
    get_chat_history, get_installed_sticker_sets, get_sticker_set, input_message_reply_to,
    load_chats, log_out, open_chat, open_message_content, reaction_type_emoji,
    remove_message_reaction, search_chat_messages, search_chats, search_messages,
    search_recently_found_chats, send_chat_action_kind, send_document, send_photo, send_sticker,
    send_text, send_voice_note, set_authentication_phone_number, view_messages,
};
