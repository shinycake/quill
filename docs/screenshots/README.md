...
| `ready-search.png` | Ready **Search** palette (`hello`) with a chat hit and a message hit. Injected `chats` / `foundMessages`, no live Telegram. Driven by `quill --screenshot-demo ready-search`. |
